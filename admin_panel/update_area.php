...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <?php
$id=$_GET['area_id'];
$src="SELECT * FROM `area` WHERE `area_id`=$id";
      ...
      <div class="row">
        ...
        <a href="view_area.php" class="btn btn-info">BACK</a>
          ...
          <div class="form-group">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" id="area_name" type="text" aria-describedby="Area name" name="area_name" placeholder="Area" value="<?php echo $rec['area_name'] ?>">
              </div>
              <div class="form-group">
		  ...
		  if (isset($_POST['ok'])){
			  ...
			  $upd="UPDATE `area` SET `area_name`='$name' WHERE `area_id`=$id";
