...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <a href="view_menu_type.php" class="btn btn-info">BACK</a>
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="menu_name" type="text" aria-describedby="Item name" name="menu_name" placeholder="Enter Menu name" value="<?php echo $rec['menu_name'] ?>">
              </div>
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <select name="category" class="form-control">
                	<option selected value="<?php echo $rec['category'] ?>"><?php echo $rec['category'] ?></option>
           ...
           <div class="form-group">
              <input type="submit" name="ok" value="Update Menu" class="btn btn-primary">
              </div>
               <?php
		  if (isset($_POST['ok'])){
			  ...
			  $upd="UPDATE `menu` SET `menu_name`='$menu_name',`category`='$category' WHERE `menu_id`=$menu_id";			 
	...
	if($res==1){
		...
		?>
        <script>
		window.location='view_menu_type.php?msg=Menu updated sucessfully'
        </script>
		<?php
	}else{
		echo"Menu not updated successfully";
	}
